...
public class BasePage {
	...
	public void swipe(int startX, int startY, int endX, int endY, int millis)
		...
		Duration millisec = Duration.ofMillis(millis);
		...
		//                .perform();
	AppiumDriver<?> android = ((AppiumDriver<?>) driver);
		new TouchAction(android).press(PointOption.point(startX, startY))
		.waitAction(WaitOptions.waitOptions(millisec)).moveTo(PointOption.point(endX, endY))
		.release().perform();
